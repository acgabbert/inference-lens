...
Registry data is separate from portable Project v7 files and never contains
...
- **Attach to project** copies the snapshot into the current project draft's
  ...
  and unsaved or loaded from an existing Project v7 file.
...
historical traces. This preserves Project v7 portability and deterministic run
