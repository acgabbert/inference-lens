...
Registry data is separate from portable Project v6 files and never contains
...
- **Attach to project** copies the snapshot into the current project draft's
  ...
  and unsaved or loaded from an existing Project v6 file.
...
historical traces. This preserves Project v6 portability and deterministic run
